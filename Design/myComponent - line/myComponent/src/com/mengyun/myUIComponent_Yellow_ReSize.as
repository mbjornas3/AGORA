...
{   
	...
	public class myUIComponent_Yellow_ReSize extends UIComponent
	{
		...
		public function myUIComponent_Yellow_ReSize()
		{			
			tmp_top=new bg3_top();
			tmp_top.x=0;
			tmp_top.y=0;
		...
		private function setHeight(event:Event):void{
			...
			tmp_middle.height = this._textArea.height;
			tmp_buttom.y = tmp_top.height + tmp_middle.height;
			downer.y = tmp_top.height + tmp_middle.height + 22;
		}
		...
		public function setText(value:String):void{
			...
			tmp_middle.height=this._text.height;
			trace('height');
			trace(tmp_middle.height);
			trace(_text.height);
			tmp_buttom.y=tmp_top.height+tmp_middle.height;
			downer.y = tmp_top.height+tmp_middle.height+22;
			trace(downer.y);
